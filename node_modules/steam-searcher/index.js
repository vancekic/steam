    ...
    request.get({
        ...
        res1.items.forEach(function(element) {
            ...
            request.get({
                    ...
                    console.log('Pushing ' + gameData[steamID].data.name + ' data to aggData!');
                    aggData.concat(aggData.push(gameData[steamID].data))
                    console.log(aggData.length + ' items in the aggregated data')
                    if (aggData.length === count) {
                        console.log('Operation terminated, ' + aggData.length + ' items in the aggregated data')
